from DataGenerator import SequenceType
import random
...
def get_all_sequences():
    return ["StraightLine", "HighPeak", "Up"
            ...
            , "RandomWaveVersion", "ECG200", "Traffic", "CrazyRandom"]
...
class Paper(SequenceType):
    ...
    def cycle_behavior(self):
        angle = 45
        rand = randrange(10, 100)/100
        divider = rand * self.seq_length / 25
        return {
            "in_cycle_randomisation": False,
            "cycles": {
                "cycle0": [["D", 0.2, angle], ["U", 0.2, angle], ["Si", 0.25, divider], ["S", 0.35, angle]]
            },
            "cycles_distribution": [1]
        }